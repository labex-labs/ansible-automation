...
<p align="center">
  <a href="https://labex.io/ru/courses/ansible-automation">
    <img src="https://course-cover.labex.io/ansible-automation.png?lang=ru" alt="Автоматизация Ansible">
  </a>
</p>
...
[Начать курс на LabEx](https://labex.io/ru/courses/ansible-automation)

## Упражнения

|   Индекс | Название                          | Сложность   | Практика                                                                                                                               |
|----------|-----------------------------------|-------------|----------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Установка и инвентаризация        | Начинающий  | <a target='_blank' href='https://labex.io/ru/labs/installation-and-inventory-636563?course=ansible-automation'>Начать лабораторию</a>  |
|        2 | Написание вашего первого Playbook | Начинающий  | <a target='_blank' href='https://labex.io/ru/labs/writing-your-first-playbook-636566?course=ansible-automation'>Начать лабораторию</a> |
|        3 | Переменные и шаблоны              | Начинающий  | <a target='_blank' href='https://labex.io/ru/labs/variables-and-templates-636565?course=ansible-automation'>Начать лабораторию</a>     |
|        4 | Организация с помощью ролей       | Начинающий  | <a target='_blank' href='https://labex.io/ru/labs/organizing-with-roles-636564?course=ansible-automation'>Начать лабораторию</a>       |
|        5 | Развертывание стека Full Stack    | Средний     | <a target='_blank' href='https://labex.io/ru/labs/full-stack-deployment-636745?course=ansible-automation'>Начать испытание</a>         |
